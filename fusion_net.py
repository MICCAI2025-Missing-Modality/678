...
class DeCUR(nn.Module):
    def __init__(self, args,common_ratio = 0.9):
        super().__init__()
        self.args = args
    ...
    def forward(self, y1_2, y2_1, shared_features):
        ...
        y1_uni = self.self_attn1(y1_unique_part, y1_unique_part, y1_unique_part)
        y2_uni = self.self_attn2(y2_unique_part, y2_unique_part, y2_unique_part)
